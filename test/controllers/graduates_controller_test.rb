...
class GraduatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create graduate" do
    assert_difference('Graduate.count') do
      post graduates_url, params: { graduate: { firstname: @graduate.firstname, grad_year_id: @graduate.grad_year_id, lastname: @graduate.lastname, middlename: @graduate.middlename } }
    end
  ...
  test "should update graduate" do
    patch graduate_url(@graduate), params: { graduate: { firstname: @graduate.firstname, grad_year_id: @graduate.grad_year_id, lastname: @graduate.lastname, middlename: @graduate.middlename } }
